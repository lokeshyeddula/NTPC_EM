...
export default function PendingReinspections() {
    ...
    async function loadPending() {
        ...
        try {
            ...
            const data =
                await inspectionService.getPendingReinspections();
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-4 sm:p-6">
                ...
                {loading ? (
                    ...
                    <div className="text-gray-500 font-medium py-6 text-center">
                        Loading pending reinspections...
                    </div>
                            ...
                            <tbody>
                                ...
                                {vehicles.length > 0 ? (
                                        ...
                                        >
                                            ...
                                            <td className="p-4 text-center">
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() =>
                                                        handleReinspection(item)
                                                    }
                                                    className="bg-orange-500 hover:bg-orange-600 text-white font-medium px-4 py-2 rounded transition-colors shadow-sm"
                                                >
                                                    Re-Inspect
                                                </button>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            colSpan={5}
                                            className="p-8 text-center text-green-600 font-medium bg-green-50/50"
                                        >
